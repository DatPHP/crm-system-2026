...
-- AddForeignKey
ALTER TABLE "order_histories" ADD CONSTRAINT "order_histories_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
