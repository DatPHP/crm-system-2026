        ...
        <div className="bg-white p-6 rounded-xl border mb-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input {...register('name')} className="w-full border rounded-lg px-3 py-2" required />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Slug</label>
              <input {...register('slug')} className="w-full border rounded-lg px-3 py-2" placeholder="auto-generated" />
            </div>
            <div className="col-span-2">
              <label className="block text-sm font-medium mb-1">Description</label>
              <textarea {...register('description')} className="w-full border rounded-lg px-3 py-2" rows={2} />
            </div>
